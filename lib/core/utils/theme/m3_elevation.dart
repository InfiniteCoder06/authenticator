...
class M3Elevation {
  ...
  Color? get surface1 => _applyOverlay(_color.surface, _color.primary, 1);

  /// ```dart
  /// Elevation Primary Suface 2 - 3px
  /// ```
  @Deprecated('Use updated colorScheme roles')
  Color? get surface2 => _applyOverlay(_color.surface, _color.primary, 3);

  /// ```dart
  /// Elevation Primary Suface 3 - 6px
  /// ```
  @Deprecated('Use updated colorScheme roles')
  Color? get surface3 => _applyOverlay(_color.surface, _color.primary, 6);

  /// ```dart
  /// Elevation Primary Suface 4 - 8px
  /// ```
  @Deprecated('Use updated colorScheme roles')
  Color? get surface4 => _applyOverlay(_color.surface, _color.primary, 8);

  /// ```dart
  /// Elevation Primary Suface 5 - 12px
  /// ```
  @Deprecated('Use updated colorScheme roles')
  Color? get surface5 => _applyOverlay(_color.surface, _color.primary, 12);

  /// ```dart
  /// Elevation Primary Suface 6 - 16px
  /// ```
  @Deprecated('Use updated colorScheme roles')
  Color? get surface6 => _applyOverlay(_color.surface, _color.primary, 16);
