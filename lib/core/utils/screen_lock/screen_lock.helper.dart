...
class ScreenLockHelper {
  static Widget dotBuilder(bool enabled, SecretConfig config) => Container(
        width: config.size,
        height: config.size,
        decoration: BoxDecoration(
          ...
          border:
              Border.all(width: config.borderSize, color: config.borderColor),
        ),
      );

  static SecretsConfig secretsConfig(ColorScheme colorScheme) => SecretsConfig(
